...
export default function Email({ icon, email }: Props) {
  ...
  return (
    <div className='hidden md:block fixed top-0 right-6 lg:right-8 xl:right-16 w-12 lg:w-16 xl:w-32 z-10'>
      <div className='flex flex-col place-items-center justify-end gap-4'>
        <motion.span
        ...
        <motion.a
          href={`mailto:${email}`}
          className='font-mono text-sm text-wm-oxygen-400 hover:text-wm-oxygen-200'
          initial='hidden'
          animate={controls}
        ...
        >
          <div className='mb-2 rotate-90'>{icon}</div>
