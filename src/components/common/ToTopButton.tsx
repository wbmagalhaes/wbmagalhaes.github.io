...
export default function ToTopButton() {
	...
	return (
		<motion.button
			...
			className="fixed bottom-5 right-5 sm:bottom-12 sm:right-12 lg:bottom-20 lg:right-20 w-12 h-12 md:w-14 md:h-14 z-[100] mt-[100vh] p-2 rounded-full shadow-md bg-wm-oxygen-600 text-wm-hydrogen hover:bg-wm-oxygen-400"
