...
export default function CardContainer() {
  ...
  return (
    <div
      ref={dragConstraint}
      className='grid grid-cols-1 md:grid-cols-3 items-start gap-8'
    >
      <Card
        zIndex={cards[0]}
        rotation={0.015}
        dragConstraint={dragConstraint}
        onDragStart={() => sendToTop(0)}
      >
        <Card.Header
          title={'Teste Header'}
          bgColor='#f00'
        ...
        <Card.Content>
          <p>
            Teste Content asd asd asd asdasdasdasd asd asda sda sdas dasdasdasd
            asd asd asd asda sdasdasd asd asdasd asdasd asd asd as asd asd asd
            asdas das das dasd asd as asd asasdasdasdasd asd asd as asd
          </p>
        </Card.Content>
        <Card.Footer>
