...
export default function CardHeader({ bgColor = 'white', title, subtitle, left, right }: Props) {
	return (
		<div className="flex p-4 gap-4 border-b-2 border-black" style={{ backgroundColor: bgColor }}>
			...
			<div className="grow-1 shrink-1 flex-auto flex flex-col items-start justify-center gap-1">
				...
				{subtitle && <div className="text-sm leading-none font-thin text-black/65">{subtitle}</div>}
			</div>
