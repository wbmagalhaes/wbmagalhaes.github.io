	...
	return (
		...
		>
			<div className="grow flex flex-col p-4 sm:pb-8 gap-4 sm:gap-6">
				<h2 className="font-sans m-0 p-0 text-center font-bold text-wm-gold-400">{name}</h2>
			...
			<button className="flex w-6 border-l-2  border-wm-gold-400 text-wm-gold-400" onClick={onClose}>
				<svg
					className="m-auto"
