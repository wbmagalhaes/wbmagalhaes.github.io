class Phase {
	...
	draw() {
		...
		if (this.subphase != null) this.subphase.draw();

		pop();
	}

	makesubphase() {
		if (this.subphase == null) this.subphase = new Phase(this.idx + 1, this.point.copy(), this.size);
		else this.subphase.makesubphase();
	}
}
